...
namespace SiLAGen.TestService
{
    ...
    public partial class TestServiceProvider : IFeatureProvider
    {
        ...
        public void Register(IServerBuilder registration)
        {
            ...
            registration.RegisterObservableCommand<CancelCommandWorksRequestDto>("CancelCommandWorks", CancelCommandWorks, null);
        ...
        /// <summary>
        /// Executes the Cancel Command Works command
        /// </summary>
        /// <param name="request">A data transfer object that contains the command parameters</param>
        /// <returns>The command response wrapped in a data transfer object</returns>
        protected virtual Tecan.Sila2.IObservableCommand CancelCommandWorks(CancelCommandWorksRequestDto request)
        {
            request.Validate();
            return new CancelCommandWorksCommand(this, request);
        }
        ...
        public System.Reflection.MethodInfo GetCommand(string commandIdentifier)
        {
            ...
            if ((commandIdentifier == "sila/contracts/TestService/v1/Command/CancelCommandWorks"))
            {
                return typeof(ITestService).GetMethod("CancelCommandWorks");
            }
        ...
        private class CancelCommandWorksCommand : Tecan.Sila2.ObservableCommand
        {
            
            private TestServiceProvider _parent;
            
            private CancelCommandWorksRequestDto _request;
            
            public CancelCommandWorksCommand(TestServiceProvider parent, CancelCommandWorksRequestDto request) : 
            ...
            {
                return _parent._implementation.CancelCommandWorks(CancellationToken);
            }
        }
    }
}
